...
class COM_details_page extends StatefulWidget {
  final id;
  COM_details_page({super.key, this.id});

  @override
  State<COM_details_page> createState() => COM_details_pageState();
}

class COM_details_pageState extends State<COM_details_page> {
  late Map dataList = {};
              ...
              SpeedDialChild(
                ...
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Modifier(id: widget.id)));
                },
              ),
            ]),
